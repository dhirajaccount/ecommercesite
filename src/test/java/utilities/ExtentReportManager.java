...
public class ExtentReportManager implements ITestListener {
	...
	public void onStart(ITestContext context) {
		...
		String reportFileName = "Opencart-Report-" + timeStamp + ".html"; // Report file name
		...
		htmlReporter.config().setReportName("<img src='https://www.opencart.com/application/view/image/icon/opencart-logo.png' height='40' width='60'>"); // Name of the report
		...
		extent.setSystemInfo("User Name", "dhiraj tayde");
	}
	...
	public void onTestFailure(ITestResult result) {
		...
		try {
			String simgPath = new BaseClass().captureScreen(result.getName());

			test.addScreenCaptureFromPath(simgPath);
